...
/**
 * test code calling humble video lib
 */
public class HumbleUnitTest
{
    @Test
    ...
    private String formatTimeStamp(long duration) {
     ...
     */
    private void getInfo(String arg) throws InterruptedException, IOException {
